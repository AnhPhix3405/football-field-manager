...
export class ConversationEntity {
  ...
  @Column({ name: 'deleted_by_sender', type: 'timestamptz', nullable: true })
  deletedBySender: Date | null;

  @Column({ name: 'deleted_by_receiver', type: 'timestamptz', nullable: true })
  deletedByReceiver: Date | null;
}
